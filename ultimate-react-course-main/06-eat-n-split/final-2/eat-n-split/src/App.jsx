...
function App() {
    ...
    return (
        <div className="app">
            ...
            {selectedFriend && (
                <FormSplitBill key={selectedFriend.id} onSplitBill={handleSplitBill} friend={selectedFriend} />
            )}
        </div>
    )
}
...
function FriendsList({ friends, onSelection, selectedFriend }) {
    return (
        <ul>
            {friends.map(friend => (
                <Friend onSelection={onSelection} key={friend.id} friend={friend} selectedFriend={selectedFriend} />
            ))}
        </ul>
    )
}
...
function FormAddFriend({ onAddFriend }) {
    ...
    return (
        <form onSubmit={handleSumbit} className="form-add-friend">
